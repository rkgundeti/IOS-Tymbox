...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
 ...
 //   NSIndexPath *selectedIndexPath = [tableView indexPathForSelectedRow];
    ...
    [dict setValue:[NSString stringWithFormat:@"%@",cell.detailTextLabel.text] forKey:@"Text"];
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"selectionText" object: dict];
